...
unsigned char byte;
unsigned char dat_header[] = { 0x00, 0x00, 0x02, 0x00, 0x00, 0x20, 0x00, 0x00 };
unsigned char *bytes;
...
int main (int argc, const char * argv[]) 
{
	...
	printf("PSEXE2ROM v1.0.1 By Alex Free & MottZilla (C)2022 3-BSD\nhttps://alex-free.github.io/psexe2rom\n");
    ...
    if(strcmp(argv[1], "-d") == 0)
    {
        ...
        printf("Writing header data 1/2...\n");
        
        for(i = 0; i < 8; i++)       
            fputc(dat_header[i], dat);
        ...
        uint32_t dat_padding = (0x2000 - dat_fn_fpos);
